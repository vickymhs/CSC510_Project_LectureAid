  ...
  results: [
    {
      ...
      simple_answer:
        "Data preprocessing is the process of transforming raw data into an understandable format. It is also an important step in data mining as we cannot work with raw data. The quality of the data should be checked before applying machine learning or data mining algorithms.Aug 10, 2021"
    },
    {
      answer:
        "https://developer.ibm.com/articles/data-preprocessing-in-detail/#:~:text=To%20ensure%20high%2Dquality%20data,data%20reduction%2C%20and%20data%20transformation.",
      question: "What are the steps in preprocessing?",
      simple_answer:
        "To ensure high-quality data, it's crucial to preprocess it. To make the process easier, data preprocessing is divided into four stages: data cleaning, data integration, data reduction, and data transformation.Jun 14, 2019"
    },
    {
      answer:
        "https://towardsdatascience.com/data-preprocessing-e2b0bed4c7fb#:~:text=Data%20preprocessing%20is%20an%20important,understandable%20after%20performing%20data%20preprocessing.",
      question: "What is importance of data preprocessing?",
      simple_answer:
        "Data preprocessing is an important task. It is a data mining technique that transforms raw data into a more understandable, useful and efficient format. Data has a better idea. This idea will be clearer and understandable after performing data preprocessing.May 13, 2020"
    },
    {
      answer:
        "https://www.sciencedirect.com/topics/engineering/data-preprocessing#:~:text=Data%20preprocessing%20is%20an%20important,to%20form%20a%20QSPR%20model.&text=Data%20cleaning%20and%20transformation%20are,used%20to%20create%20a%20model.",
    ...
    {
      answer:
        "https://ncss-wpengine.netdna-ssl.com/wp-content/themes/ncss/pdf/Procedures/NCSS/Subset_Selection_in_Multiple_Regression.pdf",
    ...
    {
      answer:
        "https://quantifyinghealth.com/best-subset-selection/#:~:text=Best%20subset%20selection%20is%20a,possible%20combinations%20of%20independent%20variables.",
    ...
    {
      answer:
        "https://home.agh.edu.pl/~wojnicki/phd/node14.html#:~:text=The%20second%20class%20of%20problems,set%20of%20constraints%20is%20satisfied.&text=For%20simplicity%2C%20it%20is%20assumed,is%20both%20discrete%20and%20finite.",
    ...
    {
      answer:
        "https://machinelearningmastery.com/principal-components-analysis-for-dimensionality-reduction-in-python/#:~:text=for%20Dimensionality%20Reduction-,Dimensionality%20Reduction%20and%20PCA,to%20predict%20the%20target%20variable.",
    ...
    {
      answer:
        "https://www.kdnuggets.com/2020/05/dimensionality-reduction-principal-component-analysis.html#:~:text=Principal%20Component%20Analysis(PCA)%20is,of%20orthogonal(perpendicular)%20axes.",
...
function getResults(filename) {
  let results = {};
  axios.get("http://127.0.0.1:5000/get-results", { params: { filename: "lecture4" } }).then((res) => {
